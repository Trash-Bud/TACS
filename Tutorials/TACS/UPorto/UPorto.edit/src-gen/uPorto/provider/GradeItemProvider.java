...
/**
 * This is the item provider adapter for a {@link uPorto.Grade} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GradeItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addGradePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Grade_grade_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Grade_grade_feature", "_UI_Grade_type"),
						UPortoPackage.Literals.GRADE__GRADE, true, false, false,
	...
	protected void addEditionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						UPortoPackage.Literals.GRADE__EDITION, true, false, true, null, null, null));
	}
	...
	protected void addStudentPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						UPortoPackage.Literals.GRADE__STUDENT, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Grade_type") + " " + grade.getGrade();
	}
