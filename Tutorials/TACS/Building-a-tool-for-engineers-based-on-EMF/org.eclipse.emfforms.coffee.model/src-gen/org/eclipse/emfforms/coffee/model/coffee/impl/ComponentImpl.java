 ...
 *   <li>{@link org.eclipse.emfforms.coffee.model.coffee.impl.ComponentImpl#getCost <em>Cost</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ComponentImpl extends MinimalEObjectImpl.Container implements Component {
	...
	public void setCost(int newCost) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CoffeePackage.COMPONENT__COST, oldCost, cost));
	}
