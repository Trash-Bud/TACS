 ...
 * @generated
 */
public class DisplayItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addWidthPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Display_width_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Display_width_feature",
								"_UI_Display_type"),
						CoffeePackage.Literals.DISPLAY__WIDTH, true, false, false,
	...
	protected void addHeightPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Display_height_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Display_height_feature",
								"_UI_Display_type"),
						CoffeePackage.Literals.DISPLAY__HEIGHT, true, false, false,
						ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Display_type") + " " + display.getWidth();
	}
