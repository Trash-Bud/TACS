...
public class ProcessorItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addVendorPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Processor_vendor_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Processor_vendor_feature",
								"_UI_Processor_type"),
						CoffeePackage.Literals.PROCESSOR__VENDOR, true, false, false,
	...
	protected void addClockSpeedPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Processor_clockSpeed_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Processor_clockSpeed_feature",
								"_UI_Processor_type"),
						CoffeePackage.Literals.PROCESSOR__CLOCK_SPEED, true, false, false,
	...
	protected void addNumberOfCoresPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Processor_numberOfCores_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Processor_numberOfCores_feature",
								"_UI_Processor_type"),
						CoffeePackage.Literals.PROCESSOR__NUMBER_OF_CORES, true, false, false,
						ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
	...
	protected void addSocketconnectorTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Processor_socketconnectorType_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Processor_socketconnectorType_feature",
								"_UI_Processor_type"),
						CoffeePackage.Literals.PROCESSOR__SOCKETCONNECTOR_TYPE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addThermalDesignPowerPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Processor_thermalDesignPower_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Processor_thermalDesignPower_feature",
								"_UI_Processor_type"),
						CoffeePackage.Literals.PROCESSOR__THERMAL_DESIGN_POWER, true, false, false,
						ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
	...
	protected void addManufactoringProcessPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Processor_manufactoringProcess_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Processor_manufactoringProcess_feature",
								"_UI_Processor_type"),
						CoffeePackage.Literals.PROCESSOR__MANUFACTORING_PROCESS, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		String label = ((Processor) object).getVendor();
