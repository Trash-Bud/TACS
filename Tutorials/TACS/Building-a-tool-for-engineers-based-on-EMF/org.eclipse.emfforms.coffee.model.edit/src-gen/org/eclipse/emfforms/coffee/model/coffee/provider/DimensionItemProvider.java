 ...
 * @generated
 */
public class DimensionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addWidthPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Dimension_width_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Dimension_width_feature",
								"_UI_Dimension_type"),
						CoffeePackage.Literals.DIMENSION__WIDTH, true, false, false,
	...
	protected void addHeightPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Dimension_height_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Dimension_height_feature",
								"_UI_Dimension_type"),
						CoffeePackage.Literals.DIMENSION__HEIGHT, true, false, false,
						ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
	...
	protected void addLengthPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Dimension_length_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Dimension_length_feature",
								"_UI_Dimension_type"),
						CoffeePackage.Literals.DIMENSION__LENGTH, true, false, false,
						ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
