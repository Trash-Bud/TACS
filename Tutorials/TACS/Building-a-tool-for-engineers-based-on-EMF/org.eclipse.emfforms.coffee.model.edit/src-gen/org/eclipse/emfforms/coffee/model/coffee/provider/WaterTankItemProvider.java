...
public class WaterTankItemProvider extends ComponentItemProvider {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WaterTank"));
	}
	...
	public String getText(Object object) {
		WaterTank waterTank = (WaterTank) object;
		return getString("_UI_WaterTank_type") + " " + waterTank.getCost();
	}
