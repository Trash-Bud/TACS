...
public class BrewingUnitItemProvider extends ComponentItemProvider {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/BrewingUnit"));
	}
	...
	public String getText(Object object) {
		BrewingUnit brewingUnit = (BrewingUnit) object;
		return getString("_UI_BrewingUnit_type") + " " + brewingUnit.getCost();
	}
