...
import org.eclipse.emf.ecp.makeithappen.model.task.Adress;
...
public class TaskPackageImpl extends EPackageImpl implements TaskPackage {
	...
	public static TaskPackage init() {
		...
		final Object registeredTaskPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		final TaskPackageImpl theTaskPackage = registeredTaskPackage instanceof TaskPackageImpl
			? (TaskPackageImpl) registeredTaskPackage
			: new TaskPackageImpl();
	 ...
	 */
	@Override
	public EAttribute getUser_Foobar() {
	 ...
	 */
	@Override
	public EReference getUser_Adress() {
	 ...
	 */
	@Override
	public EAttribute getAdress_Street() {
	...
	public void createPackageContents() {
		...
		createEAttribute(userEClass, USER__FOOBAR);
		createEReference(userEClass, USER__ADRESS);
		...
		createEAttribute(adressEClass, ADRESS__STREET);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getUser_LastName(), ecorePackage.getEString(), "lastName", null, 1, 1, User.class, !IS_TRANSIENT, //$NON-NLS-1$
			!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getUser_Gender(), getGender(), "gender", null, 0, 1, User.class, !IS_TRANSIENT, //$NON-NLS-1$
			!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getUser_Heigth(), ecorePackage.getEInt(), "heigth", null, 0, 1, User.class, !IS_TRANSIENT, //$NON-NLS-1$
			!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getUser_Nationality(), getNationality(), "nationality", null, 0, 1, User.class, //$NON-NLS-1$
			!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getUser_Tasks(), getTask(), getTask_Assignee(), "tasks", null, 0, -1, User.class, //$NON-NLS-1$
			!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		initEAttribute(getUser_Foobar(), ecorePackage.getEString(), "foobar", null, 0, 1, User.class, !IS_TRANSIENT, //$NON-NLS-1$
			!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getUser_Adress(), getAdress(), null, "adress", null, 0, 1, User.class, !IS_TRANSIENT, //$NON-NLS-1$
			!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
			IS_ORDERED);
		...
		initEClass(adressEClass, Adress.class, "Adress", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEAttribute(getAdress_Street(), ecorePackage.getEString(), "street", null, 0, 1, Adress.class, !IS_TRANSIENT, //$NON-NLS-1$
			!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAdress_Country(), ecorePackage.getEString(), "country", null, 0, 1, Adress.class, //$NON-NLS-1$
			!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
