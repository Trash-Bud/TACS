 ...
 * <li>{@link org.eclipse.emf.ecp.makeithappen.model.task.impl.UserImpl#getFoobar <em>Foobar</em>}</li>
 * <li>{@link org.eclipse.emf.ecp.makeithappen.model.task.impl.UserImpl#getAdress <em>Adress</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UserImpl extends MinimalEObjectImpl.Container implements User {
	...
	/**
	 * The default value of the '{@link #getFoobar() <em>Foobar</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 *
	 * @see #getFoobar()
	 ...
	 * @ordered
	 */
	protected static final String FOOBAR_EDEFAULT = null;

	/**
	 * The cached value of the '{@link #getFoobar() <em>Foobar</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 *
	 * @see #getFoobar()
	 ...
	 * @ordered
	 */
	protected String foobar = FOOBAR_EDEFAULT;
	...
	public EList<Task> getTasks() {
		if (tasks == null) {
			tasks = new EObjectWithInverseResolvingEList<>(Task.class, this, TaskPackage.USER__TASKS,
	...
	public void setFoobar(String newFoobar) {
		final String oldFoobar = foobar;
		foobar = newFoobar;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, TaskPackage.USER__FOOBAR, oldFoobar, foobar));
		}
	}
	...
	public NotificationChain basicSetAdress(Adress newAdress, NotificationChain msgs) {
		final Adress oldAdress = adress;
		adress = newAdress;
		if (eNotificationRequired()) {
			final ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
				TaskPackage.USER__ADRESS,
				oldAdress, newAdress);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newAdress != adress) {
			...
			if (adress != null) {
				msgs = ((InternalEObject) adress).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - TaskPackage.USER__ADRESS, null, msgs);
			}
			if (newAdress != null) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, TaskPackage.USER__ADRESS, newAdress, newAdress));
		}
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case TaskPackage.USER__FOOBAR:
			return FOOBAR_EDEFAULT == null ? foobar != null : !FOOBAR_EDEFAULT.equals(foobar);
		case TaskPackage.USER__ADRESS:
			return adress != null;
		}
	...
	public String toString() {
		...
		result.append(email);
		result.append(", foobar: "); //$NON-NLS-1$
